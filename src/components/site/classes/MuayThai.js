          ...
          <main className="classes-page">
            ...
            <div className="classes-page__description">
              ...
              <p>
                ...
                <br />
                <img
                  className="classes-page__kruang"
                  src="/images/kruang_white.png"
                  alt="kruang_white"
                />
                <img
                  className="classes-page__kruang"
                  src="/images/kruang_yellow.png"
                  alt="kruang_yellow"
                />
                <img
                  className="classes-page__kruang"
                  src="/images/kruang_white_yellow.png"
                  alt="kruang_white_yellow"
                />
                <img
                  className="classes-page__kruang"
                  src="/images/kruang_green.png"
                  alt="kruang_green"
                />
                <img
                  className="classes-page__kruang"
                  src="/images/kruang_white_green.png"
                  alt="kruang_white_green"
                />
                <img
                  className="classes-page__kruang"
                  src="/images/kruang_blue.png"
                  alt="kruang_blue"
                />
                <img
                  className="classes-page__kruang"
                  src="/images/kruang_white_blue.png"
                  alt="kruang_white_blue"
                />
                <img
                  className="classes-page__kruang"
                  src="/images/kruang_red.png"
                  alt="kruang_red"
                />
                <img
                  className="classes-page__kruang"
                  src="/images/kruang_white_red.png"
                  alt="kruang_white_red"
                />
                <img
                  className="classes-page__kruang"
                  src="/images/kruang_red_red.png"
                  alt="kruang_red_red"
                />
                <img
                  className="classes-page__kruang"
                  src="/images/kruang_white_red_red.png"
                  alt="kruang_white_red_red"
                />
                <img
                  className="classes-page__kruang"
                  src="/images/kruang_red_yellow.png"
                  alt="kruang_red_yellow"
                />
                <img
                  className="classes-page__kruang"
                  src="/images/kruang_red_gray.png"
                  alt="kruang_red_gray"
                />
                <img
                  className="classes-page__kruang"
                  src="/images/kruang_gray.png"
                  alt="kruang_gray"
                />
                <img
                  className="classes-page__kruang"
                  src="/images/kruang_strong_yellow.png"
                  alt="kruang_strong_yellow"
                />
                <br />
                <br />
